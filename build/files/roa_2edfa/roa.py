...
def screen_update():  # need an update for more edfa
    if Param.current_screen == 0 or Param.current_screen == 1:  # EDFA 1 or 2 MONITORING
    ...
    elif Param.current_screen == 2 or Param.current_screen == 3:
        ...
        if edfas[identifier]['number_of_laser'] == 1:
            ...
            if page.page_position == 1:
                ...
                fill_with_blank(edfas[identifier]['GC_setpoint'])
                lcd.message('%2.1f' % (edfas[identifier]['GC_setpoint']))
    elif Param.current_screen == 4 or Param.current_screen == 5:  # EDFA1 ALARMS
        x = 9
        y = 0
...
tab = [EDFA1_MONITORING, EDFA2_MONITORING, EDFA1_SETTINGS, EDFA2_SETTINGS,
       EDFA1_ALARMS, EDFA2_ALARMS, INFORMATIONS]
