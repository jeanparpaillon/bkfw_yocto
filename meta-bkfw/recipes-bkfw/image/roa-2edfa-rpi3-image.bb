...
export IMAGE_BASENAME = "roa-2edfa-rpi3"
...
setup_target_image() {
    ...
    install -m 0644 ${TOPDIR}/files/roa_2edfa/factory.config ${IMAGE_ROOTFS}${localstatedir}/lib/bkfw/factory.config
    ...
    install -m 0755 -o root -g root ${TOPDIR}/files/roa_2edfa/roa.py ${IMAGE_ROOTFS}/usr/bin/roa.py
}
