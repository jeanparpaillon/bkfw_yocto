...
class Info(Resource):
    ...
    """
    def __init__(self):
        super(Info, self).__init__(baseurl + "/api/edfa")
...
class EDFA(Resource):
    ...
    def __init__(self, index):
        self.index = index
        super(EDFA, self).__init__(baseurl + "/api/mcu/%d" % (index))
    ...
    if Param.current_screen == 0: #EDFA1 MONITORING
        if edfas[1]['number_of_laser'] == 1:	
            if EDFA1_MONITORING.page_position == 1:
                if edfas[1]['has_input_PD'] == True  and edfas[1]['has_output_PD'] == True:
                    lcd.set_cursor(5,0)
                    fill_with_blank(edfas[1]['powerPd']['1']['value'])
                    lcd.message('%2.1f' % (edfas[1]['powerPd']['1']['value']))
                    lcd.set_cursor(5,1)
                    fill_with_blank(edfas[1]['powerPd']['2']['value'])
                    lcd.message('%2.1f' % (edfas[1]['powerPd']['2']['value']))
                elif edfas[1]['has_input_PD'] == False and edfas[1]['has_output_PD'] == True:
                    lcd.set_cursor(5,0)
                    fill_with_blank(edfas[1]['powerPd']['2']['value'])
                    lcd.message('%2.1f' % (edfas[1]['powerPd']['2']['value']))
                    lcd.set_cursor(6,1)
                    lcd.message('%5.0f' % (edfas[1]['lasers']['1']['curAmp']))
                    ...
                    lcd.message('%5.0f' % (edfas[1]['lasers']['1']['curAmp']))
                    lcd.set_cursor(5,1)
                    fill_with_blank(edfas[1]['curInternalTemp'])
                    lcd.message('%2.1f' % (edfas[1]['curInternalTemp']))
            ...
            if EDFA1_MONITORING.page_position == 1 and edfas[1]['type'] == 'EDFA':
                if edfas[1]['has_input_PD'] == True  and edfas[1]['has_output_PD'] == True:
                    lcd.set_cursor(5,0)
                    fill_with_blank(edfas[1]['powerPd']['1']['value'])
                    lcd.message('%2.1f' % (edfas[1]['powerPd']['1']['value']))
                    ...
                    lcd.message('%5.0f' % (edfas[1]['lasers']['1']['curAmp']))
                    lcd.set_cursor(6,1)
                    lcd.message('%5.0f' % (edfas[1]['lasers']['2']['curAmp']))
            elif EDFA1_MONITORING.page_position == 1 and edfas[1]['type'] == 'RAMAN':
                lcd.set_cursor(5,0)
                fill_with_blank(edfas[1]['powerPd']['1']['value'])
                lcd.message('%2.1f' % (edfas[1]['powerPd']['1']['value']))
                lcd.set_cursor(6,1)
                lcd.message('%4.0f' % (edfas[1]['powerPd']['2']['value']))
            elif EDFA1_MONITORING.page_position == 2 and edfas[1]['type'] == 'RAMAN':
                lcd.set_cursor(5,0)
                fill_with_blank(edfas[1]['powerPd']['3']['value'])
                lcd.message('%2.1f' % (edfas[1]['powerPd']['3']['value']))
                lcd.set_cursor(5,1)
                fill_with_blank(edfas[1]['curInternalTemp'])
                lcd.message('%2.1f' % (edfas[1]['curInternalTemp']))
            elif EDFA1_MONITORING.page_position == 3 and edfas[1]['type'] == 'RAMAN':
                lcd.set_cursor(6,0)
                lcd.message('%5.0f' % (edfas[1]['lasers']['1']['curAmp']))
                lcd.set_cursor(6,1)
                lcd.message('%5.0f' % (edfas[1]['lasers']['2']['curAmp']))
            elif EDFA1_MONITORING.page_position == 2 and edfas[1]['type'] == 'EDFA':  
                if edfas[1]['has_input_PD'] == True  and edfas[1]['has_output_PD'] == True:
                    lcd.set_cursor(6,0)
                    lcd.message('%5.0f' % (edfas[1]['lasers']['1']['curAmp']))
                    lcd.set_cursor(6,1)
                    ...
                    fill_with_blank(edfas[1]['curInternalTemp'])
                    lcd.message('%2.1f' % (edfas[1]['curInternalTemp']))
            elif EDFA1_MONITORING.page_position == 3 and edfas[1]['type'] == 'EDFA':
                lcd.set_cursor(5,0)
                fill_with_blank(edfas[1]['curInternalTemp'])
                lcd.message('%2.1f' % (edfas[1]['curInternalTemp']))
        ...
        if edfas[1]['number_of_laser'] == 1:
            if EDFA1_SETTINGS.page_position == 1:
                lcd.set_cursor(2,1)
                if edfas[1]['operatingMode'] == OFF:
                    lcd.message('OFF')
                elif edfas[1]['operatingMode'] == CC:
                    lcd.message(' CC')
                elif edfas[1]['operatingMode'] == PC:
                    lcd.message(' PC')
                elif edfas[1]['operatingMode'] == GC:
                    lcd.message(' GC')
            elif EDFA1_SETTINGS.page_position == 2:
                lcd.set_cursor(0,1)
                lcd.message('%5.0f' % (edfas[1]['lasers']['1']['ampConsign']))
            elif EDFA1_SETTINGS.page_position == 3:
                lcd.set_cursor(0,1)
                if edfas[1]['has_PC_mode'] == True :
                    fill_with_blank(edfas[1]['outputPowerConsign']['value'])
                    lcd.message('%2.1f' % (edfas[1]['outputPowerConsign']['value']))
                elif edfas[1]['has_GC_mode'] == True:
                    fill_with_blank(edfas[1]['gainConsign'])
                    lcd.message('%2.1f' % (edfas[1]['gainConsign']))
            ...
            if EDFA1_SETTINGS.page_position == 1:
                ...
                lcd.set_cursor(0,1)
                lcd.message('%5.0f' % (edfas[1]['lasers']['2']['ampConsign']))
            elif EDFA1_SETTINGS.page_position == 4 and edfas[1]['type'] == 'EDFA':
                lcd.set_cursor(0,1)
                if edfas[1]['has_PC_mode'] == True :
                    fill_with_blank(edfas[1]['outputPowerConsign']['value'])
                    lcd.message('%2.1f' % (edfas[1]['outputPowerConsign']['value']))
                    ...
                    fill_with_blank(edfas[1]['gainConsign'])
                    lcd.message('%2.1f' % (edfas[1]['gainConsign']))
            elif EDFA1_SETTINGS.page_position == 4 and edfas[1]['type'] == 'RAMAN':
                lcd.set_cursor(0,1)
                lcd.message('%5.0f' % (edfas[1]['outputPowerConsign']['value']))
        ...
        if edfas[1]['alarms'].count('pin') == 1:
            ...
            if x > 15:
                ...
                x = 3
            lcd.message(' IN')
        if edfas[1]['alarms'].count('bref') == 1:
            x += 3
            if x > 15:
                for a in range(x-3,16):
                    lcd.set_cursor(a,y)
...
def which_parameter(page):
    if page == 1:
        Set.temp_value = edfas[1]['operatingMode']
        return SET_mode
    elif page == 2:
        Set.temp_value = edfas[1]['lasers']['1']['ampConsign']
        return SET_CC1
    elif page == 3 and edfas[1]['number_of_laser'] == 2:
        Set.temp_value = edfas[1]['lasers']['2']['ampConsign']
        return SET_CC2
    elif page == 3 and edfas[1]['has_PC_mode'] == True:
        Set.temp_value = edfas[1]['outputPowerConsign']['value']
        return SET_PC
    elif page == 3 and edfas[1]['has_GC_mode'] == True:
        Set.temp_value = edfas[1]['gainConsign']
        return SET_GC
...
def check_buttons():
    if GPIO.event_detected(Button_LEFT):
        if Set.flag:
            if Set.settable_value != SET_mode:
                if Set.cursor_position == 4 and (Set.settable_value == SET_PC or Set.settable_value == SET_GC) and edfas[1]['type'] == 'EDFA':
        ...
        if Set.flag:
            if Set.settable_value != SET_mode:
                if Set.cursor_position == 2 and (Set.settable_value == SET_PC or Set.settable_value == SET_GC) and edfas[1]['type'] == 'EDFA':
                    Set.cursor_position += 2
                else:
                    Set.cursor_position += 1
        ...
        if Set.flag:
            if Set.settable_value == SET_mode:
                ...
                if Set.temp_value <= 0:
                    ...
                    if Set.temp_value >= edfas[1]['limits']['cc']['1']:
                        Set.temp_value = edfas[1]['limits']['cc']['1']
                elif Set.settable_value == SET_CC2:
                    if Set.temp_value >= edfas[1]['limits']['cc']['2']:
                        Set.temp_value = edfas[1]['limits']['cc']['2']
                lcd.blink(False)
                lcd.set_cursor(0,1)
                ...
                if edfas[1]['type'] == 'EDFA':
                    Set.temp_value += tab_PC_GC[Set.cursor_position]
                else:
                    Set.temp_value += tab_CC[Set.cursor_position]
                if Set.settable_value == SET_PC:
                    if Set.temp_value <= edfas[1]['limits']['pc']['min']['value']:
                        Set.temp_value = edfas[1]['limits']['pc']['min']['value']
                    elif Set.temp_value >= edfas[1]['limits']['pc']['max']['value']:
                        Set.temp_value = edfas[1]['limits']['pc']['max']['value']
                elif Set.settable_value == SET_GC:
                    if Set.temp_value <= edfas[1]['limits']['gc']['min']['value']:
                        Set.temp_value = edfas[1]['limits']['gc']['min']['value']
                    elif Set.temp_value >= edfas[1]['limits']['gc']['max']['value']:
                        Set.temp_value = edfas[1]['limits']['gc']['max']['value']
                lcd.blink(False)
                lcd.set_cursor(0,1)
                if edfas[1]['type'] == 'EDFA':
...
if Param['number_of_edfa'] == 1:
    if edfas[1]['number_of_laser'] == 1:
        ...
        if edfas[1]['type'] == 'EDFA':
            ...
            Monitoring_PAGE_4 = None
            Monitoring_PAGE_5 = None
        elif edfas[1]['type'] == 'RAMAN':
            Monitoring_PAGE_1 = 'IN      .  dBm \x01\nOUT     .  mW  \x02'
            Monitoring_PAGE_2 = 'BR      .  dBm \x01\nTEMP    .  C   \x02'
            Monitoring_PAGE_3 = 'LC1         mA \x01\nLC2         mA \x02'
            Monitoring_nb = 3
            Monitoring_PAGE_4 = None
            Monitoring_PAGE_5 = None
        # SETTINGS
        ...
        if edfas[1]['has_PC_mode'] == True and edfas[1]['has_GC_mode'] == True and edfas[1]['type'] == 'EDFA':
            Settings_PAGE_4 = '  PC SETPOINT  \x01\n  .  dBm (set) \x02'
            Settings_PAGE_5 = '  GC SETPOINT  \x01\n  .  dBm (set) \x02'
            Settings_nb = 5
        elif edfas[1]['has_PC_mode'] == False and edfas[1]['has_GC_mode'] == True and edfas[1]['type'] == 'EDFA':
            Settings_PAGE_4 = '  GC SETPOINT  \x01\n  .  dBm (set) \x02'
            Settings_PAGE_5 = None
            Settings_nb = 4
        elif edfas[1]['has_PC_mode'] == True and edfas[1]['has_GC_mode'] == False and edfas[1]['type'] == 'EDFA':
            Settings_PAGE_4 = '  PC SETPOINT  \x01\n  .  dBm (set) \x02'
            Settings_PAGE_5 = None
            Settings_nb = 4
        elif edfas[1]['has_PC_mode'] == False and edfas[1]['has_GC_mode'] == False and edfas[1]['type'] == 'EDFA':
            Settings_PAGE_4 = None
            Settings_PAGE_5 = None
            Settings_nb = 3
        elif edfas[1]['type'] == 'RAMAN':
